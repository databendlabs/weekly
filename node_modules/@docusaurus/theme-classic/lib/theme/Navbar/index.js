    ...
    [_stylesModule.default.navbarHidden]: hideOnScroll && !isNavbarVisible
      ...
      <div className="navbar__inner">
        <div className="navbar__items">
          {(items === null || items === void 0 ? void 0 : items.length) > 0 && <button aria-label="Navigation bar toggle" className="navbar__toggle clean-btn" type="button" tabIndex={0} onClick={mobileSidebar.toggle} onKeyDown={mobileSidebar.toggle}>
              <_IconMenu.default />
            </button>}
          <_Logo.default className="navbar__brand" imageClassName="navbar__logo" titleClassName="navbar__title" />
